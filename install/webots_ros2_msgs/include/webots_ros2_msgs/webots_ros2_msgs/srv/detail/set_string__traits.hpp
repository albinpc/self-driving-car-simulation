...
[[deprecated("use webots_ros2_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const webots_ros2_msgs::srv::SetString_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  webots_ros2_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use webots_ros2_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const webots_ros2_msgs::srv::SetString_Event & msg)
{
  return webots_ros2_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<webots_ros2_msgs::srv::SetString_Event>()
{
  return "webots_ros2_msgs::srv::SetString_Event";
}

template<>
inline const char * name<webots_ros2_msgs::srv::SetString_Event>()
{
  return "webots_ros2_msgs/srv/SetString_Event";
}
