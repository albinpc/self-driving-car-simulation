...
static const _GetBool_Event_type_support_symbol_names_t _GetBool_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, webots_ros2_msgs, srv, GetBool_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, webots_ros2_msgs, srv, GetBool_Event)),
  }
};
...
{
  return &::webots_ros2_msgs::srv::rosidl_typesupport_cpp::GetBool_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, webots_ros2_msgs, srv, GetBool_Event)() {
  return get_message_type_support_handle<webots_ros2_msgs::srv::GetBool_Event>();
}
...
static const rosidl_service_type_support_t GetBool_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<webots_ros2_msgs::srv::GetBool_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<webots_ros2_msgs::srv::GetBool_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<webots_ros2_msgs::srv::GetBool_Event>(),
