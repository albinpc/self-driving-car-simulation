...
enum
{
  webots_ros2_msgs__srv__EmitterSendString_Event__request__MAX_SIZE = 1
};
// response
enum
{
  webots_ros2_msgs__srv__EmitterSendString_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/EmitterSendString in the package webots_ros2_msgs.
typedef struct webots_ros2_msgs__srv__EmitterSendString_Event
{
  service_msgs__msg__ServiceEventInfo info;
  webots_ros2_msgs__srv__EmitterSendString_Request__Sequence request;
  webots_ros2_msgs__srv__EmitterSendString_Response__Sequence response;
} webots_ros2_msgs__srv__EmitterSendString_Event;

// Struct for a sequence of webots_ros2_msgs__srv__EmitterSendString_Event.
typedef struct webots_ros2_msgs__srv__EmitterSendString_Event__Sequence
{
